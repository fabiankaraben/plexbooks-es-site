...
import type { Blog, GitBook, DocumentTypes } from 'contentlayer/generated'
...
export function descSortedGitBookPost(allGitBooks: GitBook[]) {
  return allGitBooks.sort((a, b) => dateSortDesc(a.date, b.date))
}

export function ascSortedGitBookPost(allGitBooks: GitBook[]) {
  return allGitBooks.sort((a, b) => dateSortAsc(a.date, b.date))
}
